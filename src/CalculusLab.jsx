...
const FLASHCARDS = [
  ...
  { category: "Derivatives", prompt: "What is the Product Rule?", answer: "For a product of functions, differentiate the first factor and multiply by the second, then add the first factor multiplied by the derivative of the second.", formula: "(fg)′ = f′g + fg′" },
  { category: "Derivatives", prompt: "What is the Quotient Rule?", answer: "For a quotient, use the denominator times the derivative of the numerator minus the numerator times the derivative of the denominator, divided by the denominator squared.", formula: "(f/g)′ = (f′g − fg′)/g²" },
